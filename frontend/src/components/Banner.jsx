            ...
            <div className="max-w-screen-2x1 container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10">
                <div className=' w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-32'>
                    <div className='space-y-12'>
                        ...
                        <p className='text-xl'>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi sunt nisi dolore natus dolorum quam ex aspernatur odio? Aperiam iure quisquam obcaecati ex, veniam iste corporis eaque.
                        </p>
